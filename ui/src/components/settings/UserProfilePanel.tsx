        ...
        <div style={{ display: "flex", justifyContent: "space-between", gap: "16px", alignItems: "flex-start", flexWrap: "wrap" }}>
          <div style={{ flex: 1, minWidth: "280px" }}>
            ...
            <p style={{ fontSize: "13px", color: "var(--j-text-muted)", margin: "8px 0 0 0", lineHeight: 1.6 }}>
              This wizard gives Sam durable context about who you are, what matters to you, and how you prefer to work.
      ...
      {editing && currentStep ? (
        ...
        <div style={cardStyle}>
          <div style={{ fontSize: "13px", color: "var(--j-text-muted)", lineHeight: 1.6 }}>
            No user profile has been saved yet. Start the wizard to give Sam a strong initial understanding of your identity,
